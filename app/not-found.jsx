...
function page() {
  return (
    <div className="flex flex-col items-center justify-center h-screen text-center">
      ...
      <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">Page Non Trouvée</p>
      <p className="mt-2 text-gray-500 dark:text-gray-400">Désolé, la page que vous recherchez n'existe pas</p>
